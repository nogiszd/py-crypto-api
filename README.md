...
|--|--|--|
|`localhost:8000/v1/{query}`  | Replace `{query}` with search phrase, for e.g. "1 btc to usd" |Outputs JSON formatted response e.g. `{"amount":"9.9"}` where `9.9` is amount of USD for 1 Bitcoin|
